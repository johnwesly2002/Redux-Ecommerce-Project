...
})({"bD85d":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "591d1417343163fb";
"use strict";
...
},{}],"cnZXZ":[function(require,module,exports,__globalThis) {
...
const rootreducer = (0, _redux.combineReducers)({
    ...
    cartItemList: (0, _cartReducerDefault.default),
    wishlistItem: (0, _wishlistReducerDefault.default)
});
const store = (0, _redux.createStore)(rootreducer, window.__REDUX_DEVTOOLS_EXTENSION__?.());
console.log(store);
const unsubscribe = store.subscribe(()=>{
    console.log(store.getState());
});
store.dispatch((0, _cartReducer.addCartItem)({
    productId: 1,
    quantity: 1
}));
store.dispatch((0, _cartReducer.removeCartItem)({
    productId: 1,
    quantity: 1
}));
store.dispatch((0, _cartReducer.addCartItem)({
...
store.dispatch((0, _cartReducer.increaseQuantity)(1, 15));
store.dispatch((0, _cartReducer.DecreaseQuantity)(1, 10));
store.dispatch((0, _wishlistReducer.addWishListItem)({
    productId: 1,
    quantity: 10
}));
store.dispatch((0, _wishlistReducer.removeWishListItem)({
    productId: 1,
    quantity: 10
}));
store.dispatch((0, _wishlistReducer.addWishListItem)({
...
store.dispatch((0, _cartReducer.DecreaseQuantity)(1, 6));
store.dispatch((0, _cartReducer.addCartItem)({
    productId: 1,
    quantity: 1
}));

},{"redux":"anWnS","@parcel/transformer-js/src/esmodule-helpers.js":"4WipD","./cartReducer":"96Hwp","./productsReducer":"9nz3D","./wishlistReducer":"77x5m"}],"anWnS":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4WipD"}],"4WipD":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4WipD"}],"9nz3D":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const initialState = (0, _productsJsDefault.default);
function productsReducer(state = (0, _productsJsDefault.default), action) {
    return state;
}

},{"./Products.js":"5zN5p","@parcel/transformer-js/src/esmodule-helpers.js":"4WipD"}],"5zN5p":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4WipD"}],"77x5m":[function(require,module,exports,__globalThis) {
//Action Types
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//Action Creator
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4WipD"}]},["bD85d","cnZXZ"], "cnZXZ", "parcelRequire94c2")

//# sourceMappingURL=ReduxEx.343163fb.js.map
